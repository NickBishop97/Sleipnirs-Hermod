...
class Writer:
    ...
    def __init__(self, myPubSubType, myPubSubType_name, myTopic_name):
        ...
        try:
            ...
            self.data = getattr(self.MessageType, "{self.MessageType_name}") #inputting the idl special datatype
        except AttributeError:
            print("{self.MessageType_name}PubSubType() not found")
        ...
        try:
            self.topic_data_type = getattr(myPubSubType, "{myPubSubType_name}PubSubType") #inputting the idl special datatype
        except AttributeError:
            print("{myPubSubType_name}PubSubType() not found")
            
        self.topic_data_type.setName(myPubSubType_name) #setting name of topic to myPubSubType_name, <idl-name>
