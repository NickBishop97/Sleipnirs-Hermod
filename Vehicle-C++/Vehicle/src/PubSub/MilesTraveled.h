...
/**
 * @brief Miles Traveled Class that will hold all the Pub/Sub for the Miles Traveled publisher
...
public:
    ...
    */
    ...
    public:
        ...
        /**
             * @brief Generates a random amount of miles travled, and Publishes Miles Traveled data 
             * onto the MilesTravled topic
             * 
             * @param data MT Object variable
             * @return true if Moving sub recieved a 1/0
             * @return false if Moving sub recieved a non 1/0 
             */
        bool publish(MT* data)
        {
            double traveled;
    ...
    */
    ...
    public:
        ...
        /**
        * @brief Will set the index into data class to 1/0 if the car is moving or not every 0.25sec
        * 
        * @param data MT Object Variable
        */
        void run(MT* data)
