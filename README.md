...
<img src= "https://confluence.sde.sp.gc1.myngc.com/download/thumbnails/305772548/Team%20Image.png?version=2&modificationDate=1654713936673&api=v2">
...
2. Installing FastDDS C++
    ...
    - **FastDDS-Gen**   _#Note: If you already installed fastdds-gen then you can skip this step_
        ...
        - Use these following commands in order
            ...
            <img src="./ect/Gradle.gif" width="697" height="279" />
        ...
        <img src="./ect/FastDDS_Example.gif" width="900" height="279" />
3. Install FastDDS Python
    - **FastDDS Python**
        ...
        - Use these following commands in order
            ...
            - source /home/<location to fast dds python folder>/FastDDS-Python/install/setup.bash   _#make  sure to change         - location to the location of the fast dds folder_
            - source ~/.bashrc
    - **Fixes**
